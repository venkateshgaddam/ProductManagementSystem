...
Execute unit tests
```
    cd "ProductManagement.ProductsProcessor/test/ProductManagement.ProductsProcessor.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "ProductManagement.ProductsProcessor/src/ProductManagement.ProductsProcessor"
