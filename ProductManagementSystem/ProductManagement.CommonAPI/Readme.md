...
WORKDIR /src
COPY ["ProductManagement.CommonAPI.csproj", "ProductManagement.CommonAPI/"]
RUN dotnet restore "ProductManagement.CommonAPI/ProductManagement.CommonAPI.csproj"

WORKDIR "/src/ProductManagement.CommonAPI"
COPY . .
RUN dotnet build "ProductManagement.CommonAPI.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "ProductManagement.CommonAPI.csproj" \
...
Execute unit tests
```
    cd "ProductManagement.CommonAPI/test/ProductManagement.CommonAPI.Tests"
    dotnet test
```

Deploy application
```
    cd "ProductManagement.CommonAPI/src/ProductManagement.CommonAPI"
