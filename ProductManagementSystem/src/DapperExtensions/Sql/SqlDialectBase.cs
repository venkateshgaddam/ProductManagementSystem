...
namespace DapperExtensions.Sql
{
    public interface ISqlDialect
    {
        ...
        #region CCP
        string ParameterPrefixFn { get; }
        string GetColumnNameFn(string columnName);
        string GetInsertAndReturnSql(string tableName, string columnNames, string valueString, string existSql);
        string GetUpdateAndReturn(string tableName, string setString, string conditionString, string existSql);
        string GetDeleteSelected(string tableName, string conditionString);
        string GetOptimizedPagingSql(string sql, int page, int resultsPerPage, IDictionary<string, object> parameters, string orderBy);
        string GetLikeOperator(bool ignoreCase);
    ...
    public abstract class SqlDialectBase : ISqlDialect
    {
        ...
        public abstract string GetLikeOperator(bool ignoreCase);
        #region CCP
        public abstract string ParameterPrefixFn { get; }
        public abstract string GetColumnNameFn(string columnName);
        public abstract string GetInsertAndReturnSql(string tableName, string columnNames, string valueString, string existSql);
        public abstract string GetUpdateAndReturn(string tableName, string setString, string conditionString, string existSql);
        public abstract string GetDeleteSelected(string tableName, string conditionString);
        public abstract string GetOptimizedPagingSql(string sql, int page, int resultsPerPage, IDictionary<string, object> parameters, string orderBy);
        #endregion CCP
